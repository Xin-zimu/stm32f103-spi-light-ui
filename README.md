...
120x120、28 帧、40 ms/帧；受 Keil 免费链接器 32 KB 镜像上限约束，
固件保留其中 10 帧，以 120 ms/帧播放，并将源像素放大 2 倍覆盖屏幕。
