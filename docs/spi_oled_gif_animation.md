...
当前阶段只验证 ST7789 240x320 屏幕是否能够可靠初始化和接收 RGB565 数据。
...
初始化成功后依次显示红、绿、蓝、白、黑。每次写满 240x320 全部可见区域，
地址范围为 X=0 至 239、Y=0 至 319。该测试不需要 Flash 图片数组或 RAM 帧缓冲。

观察结果：

- 五种颜色循环：通信、初始化和 RGB565 写入正常。
