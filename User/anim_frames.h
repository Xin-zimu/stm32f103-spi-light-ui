...
#define ANIM_FRAME_COUNT          10U     // Number of retained GIF frames
#define ANIM_FRAME_INTERVAL_MS    120U     // Display time per retained frame
#define ANIM_FIRST_FRAME_SIZE     7200U   // Packed first-frame bytes
#define ANIM_DELTA_DATA_SIZE      21099U  // Encoded bytes for frames 1..N
