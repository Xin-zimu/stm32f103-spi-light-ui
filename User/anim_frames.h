...
#define ANIM_FRAME_COUNT          9U     // Number of retained GIF frames
#define ANIM_FRAME_INTERVAL_MS    125U     // Display time per retained frame
#define ANIM_FIRST_FRAME_SIZE     7200U   // Packed first-frame bytes
#define ANIM_DELTA_DATA_SIZE      18950U  // Encoded bytes for all transitions
